...
Report for commit SHA: 2ad981dcabf210e70e29bb514c1531e1bb02c58e
...
### Output
    ...
    Test SIMPLE2: FAILED in 0.001 sec
        command  `echo Double Hooray`
        expected `Double Hooray`
        got      `start_command not done yet run_command not done yet`
    Test SIMPLE3: FAILED in 0.001 sec
        command  `cat f3.txt`
    ...
    Test PIPE16: FAILED in 0.001 sec
        ...
        expected `True`
        got      `start_command not done yet run_command not done yet`
    Test PIPE17: FAILED in 0.001 sec
    ...
    Test REDIR2: FAILED in 0.001 sec
        command  `tr pq Fi < fREDIR2.txt ; echo Done`
        expected `File Done`
        got      `start_command not done yet run_command not done yet`
    Test REDIR3: FAILED in 0.001 sec
        command  `perl -e 'print STDERR 1851' 2> fREDIR3.txt ; grep '^[1-9]' fREDIR3.txt | wc -l ; rm -f fREDIR3.txt`
        expected `1`
        got      `start_command not done yet run_command not done yet`
    Test REDIR4: FAILED in 0.001 sec
        command  `perl -e 'print STDERR 1851; print STDOUT "X"' > fREDIR4a.txt 2> fREDIR4b.txt ; grep '^[1-9]' fREDIR4a.txt | wc -l ; grep '^[1-9]' fREDIR4b.txt | wc -l ; cmp -s fREDIR4a.txt fREDIR4b.txt || echo Different`
        expected `0 1 Different`
        got      `start_command not done yet run_command not done yet`
    Test REDIR5: FAILED in 0.001 sec
        command  `tr hb HB < fREDIR5.txt | sort | ../sh0019 -q cmdREDIR5.sh`
        expected `Bye Hello First Good`
        got      `start_command not done yet run_command not done yet`
    Test REDIR6: FAILED in 0.001 sec
        command  `sort < fREDIR6a.txt > fREDIR6b.txt ; tail -n 2 fREDIR6b.txt ; rm -f fREDIR6a.txt fREDIR6b.txt`
        expected `Bye Hello`
        got      `start_command not done yet run_command not done yet`
    Test REDIR7: FAILED in 0.001 sec
    ...
    Test REDIR8: FAILED in 0.001 sec
        ...
        expected `No such file or directory`
        got      `start_command not done yet run_command not done yet`
    Test REDIR9: FAILED in 0.001 sec
    ...
    Test REDIR10: FAILED in 0.002 sec
        ...
        expected `No such file or directory`
        got      `start_command not done yet run_command not done yet`
    Test REDIR11: FAILED in 0.001 sec
    ...
    Test REDIR12: FAILED in 0.001 sec
        ...
        expected `No such file or directory Wanted`
        got      `start_command not done yet run_command not done yet`
    Test REDIR13: FAILED in 0.001 sec
    ...
    Test REDIR15: FAILED in 0.001 sec
        command  `cat < xoqted.txt | tr xoq Wan | cat > output.txt`
        expected `output.txt is Wanted`
        got      `start_command not done yet run_command not done yet output.txt is cat: outpu...`
    Test REDIR16: FAILED in 0.001 sec
    ...
    Test CD7: FAILED in 0.002 sec
        ...
        expected `/`
        got      `start_command not done yet run_command not done yet`
    Test CD8: FAILED in 0.002 sec
        command  `cd / ; cd /doesnotexist 2> /dev/null > /dev/null ; pwd`
        expected `/`
        got      `start_command not done yet run_command not done yet`
    Test ADVPIPE1: FAILED in 0.002 sec
