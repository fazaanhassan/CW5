...
Report for commit SHA: 8771c01756b967de9741ade140dd89434c7ce719
...
### Output
    ...
    sh0019.c:234:14: warning: unused variable myHead [-Wunused-variable]
         command* myHead = c;
                  ^
    ...
    Test LIST4: passed
    Test LIST5: passed
    Test LIST6: FAILED in 0.261 sec
    ...
    Test LIST8: passed
    Test COND1: passed
    Test COND2: FAILED in 0.020 sec
    ...
    Test COND5: passed
    Test COND6: passed
    Test COND7: FAILED in 0.004 sec
    ...
    Test PIPE1: FAILED in 0.004 sec
        ...
        expected `5`
        got      `Pipe 0`
    Test PIPE2: FAILED in 0.014 sec
        command  `echo Good | grep -n G`
        expected `1:Good`
        got      `Good`
    Test PIPE3: FAILED in 0.010 sec
        command  `echo Bad | grep -c G`
        expected `0`
        got      `Bad 0`
    Test PIPE4: FAILED in 0.014 sec
        command  `echo Line | cat | wc -l`
        expected `1`
        got      `Line 0`
    Test PIPE5: FAILED in 0.026 sec
        command  `../sh0019 -q cmdPIPE5.sh; ps | grep sleep | grep -v grep | head -n 1 | wc -l`
        expected `Hello Bye 1`
        got      `Bye Hello PID TTY TIME CMD 1791 pts/0 00:00:00 bash 1811 pts/0 00:00:00 ente...`
    Test PIPE6: FAILED in 0.030 sec
    ...
    Test PIPE7: FAILED in 0.006 sec
        ...
        expected `goHangasaLAmIimalaSAgnaHoG`
        got      `GoHangASalamiImALasagnaHog`
    Test PIPE8: FAILED in 0.026 sec
    ...
    Test PIPE12: FAILED in 0.004 sec
        ...
        expected `Desired`
        got      `Ignored Desired`
    Test PIPE13: FAILED in 0.182 sec
        command  `../sh0019 -q cmdPIPE13.sh &`
        expected `Hello 1`
        got      `Hello PID TTY STAT TIME COMMAND 1791 pts/0 Ss 0:00 bash -c sh -c cd /home/us...`
    ...
    Test PIPE19: FAILED in 0.007 sec
        ...
        expected `NoXs`
        got      `Hello poqs`
    Test PIPE20: FAILED in 0.005 sec
        command  `echo Yes | grep -q Y && echo fs | tr f Y`
        expected `Ys`
        got      `Yes`
    Test PIPE21: passed
    Test PIPE22: passed
    Test PIPE23: FAILED in 0.007 sec
    ...
    Test REDIR3: FAILED in 0.006 sec
        command  `perl -e 'print STDERR 1840' 2> fREDIR3.txt ; grep '^[1-9]' fREDIR3.txt | wc -l ; rm -f fREDIR3.txt`
        expected `1`
        got      `18400`
    Test REDIR4: FAILED in 0.009 sec
        command  `perl -e 'print STDERR 1840; print STDOUT "X"' > fREDIR4a.txt 2> fREDIR4b.txt ; grep '^[1-9]' fREDIR4a.txt | wc -l ; grep '^[1-9]' fREDIR4b.txt | wc -l ; cmp -s fREDIR4a.txt fREDIR4b.txt || echo Different`
        expected `0 1 Different`
        got      `1840Xgrep: fREDIR4a.txt: No such file or directory 0 grep: fREDIR4b.txt: No ...`
    Test REDIR5: FAILED in 0.007 sec
    ...
    Test REDIR6: FAILED in 0.492 sec
    ...
    Test INTR3: FAILED in 0.205 sec
    ...
    Test ADVPIPE1: FAILED in 0.300 sec
      ...
      output file size 214958080, expected <= 1000
