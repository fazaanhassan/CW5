...
Report for commit SHA: 72baae57e273c7ccf8163c9f3bc7a15ef4d053cc
...
### Output
    ...
    sh0019.c:138:9: warning: unused variable child_status [-Wunused-variable]
         int child_status;
             ^
    sh0019.c: In function eval_line:
    sh0019.c:180:9: warning: unused variable flag [-Wunused-variable]
         int flag = 0;
             ^
      COMPILE helpers.c
      LINK sh0019 
    ...
    Test LIST5: passed
    Test LIST6: passed
    Test LIST7: FAILED in 0.005 sec
    ...
    Test COND3: FAILED in 0.001 sec
        ...
        expected `277 Wanted`
        got      `../sh0019.c:277 grep: echo: No such file or directory grep: Wanted: No such ...`
    ...
    Test COND5: FAILED in 0.026 sec
    ...
    Test PIPE4: FAILED in 0.003 sec
        ...
        expected `1`
        got      `Line | cat | wc -l`
    Test PIPE5: FAILED in 0.005 sec
    ...
    Test PIPE7: FAILED in 0.013 sec
    ...
    Test PIPE11: FAILED in 0.003 sec
    ...
    Test REDIR3: FAILED in 0.007 sec
        command  `perl -e 'print STDERR 1871' 2> fREDIR3.txt ; grep '^[1-9]' fREDIR3.txt | wc -l ; rm -f fREDIR3.txt`
        expected `1`
        got      `1871grep: |: No such file or directory grep: wc: No such file or directory`
    Test REDIR4: FAILED in 0.008 sec
        command  `perl -e 'print STDERR 1871; print STDOUT "X"' > fREDIR4a.txt 2> fREDIR4b.txt ; grep '^[1-9]' fREDIR4a.txt | wc -l ; grep '^[1-9]' fREDIR4b.txt | wc -l ; cmp -s fREDIR4a.txt fREDIR4b.txt || echo Different`
        expected `0 1 Different`
        got      `1871Xgrep: fREDIR4a.txt: No such file or directory grep: |: No such file or ...`
    ...
    Test REDIR6: FAILED in 0.012 sec
    ...
    Test INTR5: FAILED in 0.001 sec
    ...
    Test CD1: FAILED in 0.015 sec
        ...
        expected `/`
        got      `/home/user/out`
    Test CD2: FAILED in 0.002 sec
        command  `cd / ; cd /usr ; pwd`
        expected `/usr`
        got      `/home/user/out`
    Test CD3: FAILED in 0.002 sec
    ...
    Test ADVPIPE1: FAILED in 0.300 sec
      ...
      output file size 176226072, expected <= 1000
    Test ADVBGCOND1: FAILED in 0.002 sec
        command  `sleep 0.2 && echo second & echo first`
        expected `first second`
        got      `sleep: invalid time interval echo sleep: invalid time interval seco...`
    Test ADVBGCOND2: FAILED in 0.003 sec
        command  `echo first && sleep 0.1 && echo third & sleep 0.05 ; echo second ; sleep 0.1 ; echo fourth`
        expected `first second third fourth`
        got      `first sleep 0.1 echo third sleep 0.05 first sleep 0.1 echo third sleep 0.05 ...`
    
    15 of 83 tests passed
